...
#'    used by Neal (2022) to illustrate \link[backbone]{disparity}. GRAND attributes have already been added
#'    using [grand()].
#'
...
#'    session (2019-2020). It was obtained using \link[incidentally]{incidence.from.congress} following the
...
#'    [cosponsor()] using \link[backbone]{sdsm} following the procedure described by Neal (2022).
